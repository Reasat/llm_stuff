...
def get_raw_dataset(dataset_name, output_path, seed, local_rank):
    """
    Get the raw dataset based on the dataset name.
    If you want to use other huggingface dataset or your own dataset, modify this function and implement dataset in raw_datasets.py 
    """
...
class IterablePromptDataset(Dataset):
    ...
    def __checker__(self, current_dataset, raw_dataset, train_phase, end_of_conversation_token):
        ...
        if train_phase == 1:
            ...
            ValueError("Invalid train phase, Only support phase 1 (SFT) now")
